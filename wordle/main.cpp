...
void playWordle() {
    ...
    while (attempts < MAX_ATTEMPTS) {
        ...
        //If you want to cheat Then do it
        // cout << word << endl;
...
void clearStatistics() {
    clearData(SUMMARY);
    clearData(STATIC);
    cout << "You successfully clear your data :D";
    cout << "\n";
    cout << "\n";
    cout << "Press [enter] to continue";
    cin.ignore(); // Ignore the newline character from the previous input
...
int main(int argc, char* argv[]) {
    ...
    switch (option) {
        case 1:
            ...
            break;
        case 2:
            // code to display how to play Wordle
            printHowToPlay();
            backtoMain();
            break;
        case 3:
            // code to display statistics summary
            printStatistics();
            backtoMain();
            break;
        case 4:
            // code to reset statistics
            clearStatistics();
            backtoMain();
            break;
        case 5:
